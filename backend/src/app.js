...
const routeReproducao = require('./api/routes/reproducaoRoutes')
const routeBoi = require('./api/routes/boiRoutes')
...
const reproS = require('./services/reproducaoService')
