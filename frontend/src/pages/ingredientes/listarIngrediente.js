    ...
    return (
        <div>
            ...
            <div className="t" style={{ margin: "5%", marginLeft: "10%", marginRight: "20%" }}>
                <div className="text-center" style={{ marginBottom: "5%" }}><button className="btn btn-success" style={{ backgroundColor: "#83A93A", borderColor: "#6D3B00" }} variant="warning" onClick={e => navigate('/ingredientes/cadastrarIngrediente')}>Cadastrar Ingrediente</button></div>
                    ...
                    <tbody className="text-center">
                        ...
                        <tr>
                            ...
                            <td style={{ display: "flex", justifyContent: "space-evenly" }}>
                                ...
                                <button className="botaoEditar btn btn-primary" style={{ color: "white", textDecoration: "none", margin: "2%" }} variant="warning" onClick={e => navigate('/ingredientes/editarIngrediente')}>
                                    Editar
