                ...
                <table className="table table-bordered table-bordered" >
                    ...
                    <tbody className="text-center">
                        {ingrediente.map(ingredientes => (
                            <tr key={ingredientes.idIngrediente}>
                                <td >{ingredientes.nome}</td>
                                <td >{ingredientes.qnt_estoque}</td>
                                <td >{ingredientes.unidade}</td>
                                <td style={{ display: "flex", justifyContent: "space-evenly" }}>

                                    <button className="botaoEditar btn btn-primary" style={{ color: "white", textDecoration: "none", margin: "2%", backgroundColor: "#47a2ed", border: "none" }} variant="warning" onClick={e => navigate('/ingredientes/editarIngrediente')}>
                                        Editar
